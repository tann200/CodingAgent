...
- **4,826** tests collecting (4,822 unit pass + 1 unit skip + 3 fast-path integration; see note below)
- **7** benchmark tests
- **0** Critical issues
- **0** High issues
...
> baseline is the number of tests it collects (currently 4,826). This is the single source of truth for
