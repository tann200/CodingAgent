...
class MessageManager:
    ...
    def _truncate_to_window(self) -> None:
        ...
        # F-78/F-85/F-86: removed dead timing block that captured elapsed as a bare
        # timestamp (not a duration) and hardcoded "elapsed": 0.0 into timings.json.
        # The entire block was unreachable in practice and produced misleading data.
