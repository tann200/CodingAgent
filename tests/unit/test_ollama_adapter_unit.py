...
class TestOllamaAdapterUnit(unittest.TestCase):
    ...
    @patch(
        ...
        read_data='{"base_url": "http://127.0.0.1:11434", "models": ["qwen3.5:9b"]}',
    )
    def test_load_provider(self, mock_file, mock_read_text):
        mock_read_text.return_value = (
            '{"base_url": "http://127.0.0.1:11434", "models": ["qwen3.5:9b"]}'
        )
    ...
    def test_update_models_list(
        self, mock_file, mock_read_text, mock_requests, mock_write_text
    ):
        mock_read_text.return_value = (
            '{"base_url": "http://127.0.0.1:11434", "models": ["qwen3.5:9b"]}'
        )
