...
├── tests/                             # 4,764 tests in current baseline (see §13)
│   ├── unit/                          # 4,761 unit tests (352 files)
...
```
tests/
├── unit/           (illustrative layout from an early suite snapshot — current count: 4,761 tests across 352 files)
