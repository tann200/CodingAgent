...
├── tests/                             # 4,850 tests in current baseline (see §13)
│   ├── unit/                          # 4,846 unit tests (356 files)
...
```
tests/
├── unit/           (illustrative layout from an early suite snapshot — current count: 4,846 tests across 356 files)
